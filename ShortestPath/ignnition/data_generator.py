...
def generate_dataset(file_name, num_samples, min_nodes=20000, max_nodes=30000, min_edge_weight=1, max_edge_weight=10, p=0.01):
    samples = []
...
generate_dataset("./data/train/data.json", 200)
